...
export default function Logo({ size, className }) {
  ...
  const sizeClass = size === 'small'
    ...
    : 'logo cursor-pointer position-absolute bottom-0 mx-auto start-0 end-0 text-center ' + className;
  // Small Logo is used in Header only and does not require a wrapper
  const sizeWrapperClass = !size ? 'logo-wrapper position-relative d-block mx-auto ' + className : undefined;
